...
from scripts_python.services.registry.status import get_status as registry_status
from scripts_python.services.database.status import get_status as database_status
from scripts_python.services.api.status import get_status as api_status
from scripts_python.services.nginx.status import get_status as nginx_status
...
def status(
    ...
    typer.echo(f"NGINX       {nginx_status(environment)}")
