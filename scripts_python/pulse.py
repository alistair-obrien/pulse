...
from scripts_python import environment
from scripts_python import registry
from scripts_python import database
from scripts_python import api

pulse_app.add_typer(environment.app, name="")

pulse_app.add_typer(registry.app, name="registry")
pulse_app.add_typer(database.app, name="database")
pulse_app.add_typer(api.app, name="api")
